...
INSERT INTO "MEMBER"
VALUES (SEQ_MEMBER_NO.NEXTVAL, 'writer','password','비타씨','F',DEFAULT,DEFAULT);
INSERT INTO "MEMBER"
VALUES (SEQ_MEMBER_NO.NEXTVAL, 'replier','password','댓글러','F',DEFAULT,DEFAULT);
...
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL, '안녕하세여','비타씨의 첫번째 글. 비타씨는 맛있다. 비타비타냠냠', 
SYSDATE,DEFAULT,DEFAULT,6); --6번회원의 게시글(게시글번호 11번됨...)
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL, '안녕하세여','비타씨의 두번째 글. 비타씨는 맛있다. 비타비타냠냠', 
SYSDATE,DEFAULT,DEFAULT,6);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL, '안녕하세여','비타씨의 세번째 글. 비타씨는 맛있다. 비타비타냠냠', 
SYSDATE,DEFAULT,DEFAULT,6);
...
INSERT INTO "COMMENT"
VALUES (SEQ_COMMENT_NO.NEXTVAL, '냠',DEFAULT,DEFAULT,7,11);
INSERT INTO "COMMENT"
VALUES (SEQ_COMMENT_NO.NEXTVAL, '맛있어',DEFAULT,DEFAULT,7,11);
SELECT * FROM "COMMENT";
COMMIT;
