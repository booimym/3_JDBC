...
public class MovieView {
	...
	public void movieMenu() {
		...
		do {
			...
			try {
				...
				System.out.println("4. 평점순 TOP3 조회");
	...
	private void selectMovie() {
		...
		try {
			...
			System.out.println("===================================");
			System.out.println("영화제목 : " + movieVo.getMovieTitle() + " | 평점 : " + movieVo.getMovieScore()); 
			System.out.println("===================================");
	...
	private void selectScoreTop3() {
		
		try {
			
			List<MovieVO> movieList = service.selectScoreTop3();
			
			
			
			for(int i = 0 ; i < movieList.size();i++) {
				
				System.out.println("["+(i+1)+"위] :" +movieList.get(i).getMovieTitle()+" | 평점 : " + movieList.get(i).getMovieScore());
